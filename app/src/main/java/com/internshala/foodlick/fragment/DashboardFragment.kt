package com.internshala.foodlick.fragment
...
import com.internshala.foodlick.R
import com.internshala.foodlick.adapter.DashboardFragmentAdapter
import com.internshala.foodlick.model.Restaurant
import com.internshala.foodlick.util.ConnectionManager
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.sort -> {
                ...
                var radioButton_high_to_low: RadioButton = radioButtonView.findViewById<RadioButton>(R.id.radio_high_to_low)
                var radioButton_low_to_high: RadioButton = radioButtonView.findViewById(R.id.radio_low_to_high)
                var radioButton_rating: RadioButton = radioButtonView.findViewById(R.id.radio_rating)

                androidx.appcompat.app.AlertDialog.Builder(activity as Context)
                    .setTitle("Sort By?")
                    .setView(radioButtonView)
                    .setPositiveButton("OK") { _, _ ->
                        if (radioButton_high_to_low.isChecked) {
                            Collections.sort(restaurantInfoList, costComparator)
                            restaurantInfoList.reverse()
                            dashboardAdapter.notifyDataSetChanged()
                        }
                        if (radioButton_low_to_high.isChecked) {
                            Collections.sort(restaurantInfoList, costComparator)
                            dashboardAdapter.notifyDataSetChanged()
                        }
