package com.internshala.foodlick.activity
...
import com.internshala.foodlick.fragment.DashboardFragment
import com.internshala.foodlick.fragment.FaqsFragment
import com.internshala.foodlick.fragment.FavoriteRestaurantFragment
import com.internshala.foodlick.fragment.ProfileFragment
            ...
            when (it.itemId) {
                ...
                R.id.favoriteRestaurants -> {
                    supportFragmentManager.beginTransaction()
                        .replace(
                            R.id.frameLayout,
                            FavoriteRestaurantFragment(this)
                        ).commit()
