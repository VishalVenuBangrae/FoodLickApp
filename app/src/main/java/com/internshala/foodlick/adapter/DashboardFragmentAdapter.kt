package com.internshala.foodlick.adapter
...
import com.internshala.foodlick.activity.RestaurantMenuActivity
import com.internshala.foodlick.database.RestaurantDatabase
import com.internshala.foodlick.database.RestaurantEntity
        ...
        holder.txtFavorite.setOnClickListener {
            if (!DBAsyncTask(context, restaurantEntity, 1).execute().get()) {
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_favourite)
